...
export default function Hero() {
  return (
    <section className="relative overflow-hidden py-20 md:py-32 bg-background transition-colors duration-300">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center z-10">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground leading-tight">
          Improve Your Resume
          <br />
          <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-650 bg-clip-text text-transparent">
            With AI Power
          </span>
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link href="/register" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto bg-foreground hover:bg-foreground/90 text-background px-8 h-12 rounded-xl transition-all shadow-xl active:scale-95 font-medium">
              Get Started Free
            </Button>
          </Link>
