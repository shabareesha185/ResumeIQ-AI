...
export default async function ResumeDetailsPage({ params }) {
  ...
  let scoreDescription =
    "Your resume score is low. Consider running an AI analysis to find critical keyword gaps.";
  ...
  if (score >= 80) {
    ...
    scoreDescription =
      "Great job! Your resume is highly optimized for applicant tracking systems.";
  } else if (score >= 60) {
    scoreColorClass = "text-amber-400 border-amber-500/20 bg-amber-500/10";
    scoreStatus = "Good Match";
    scoreDescription =
      "Solid start. A few simple additions can push you to the high-ranking category.";
  }
          ...
          {isPdf ? (
            ...
            <Card className="flex-1 border-zinc-900 bg-zinc-950/40 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center p-10 text-center border-dashed border-2">
              ...
              <p className="mt-3 text-zinc-400 text-sm max-w-md leading-relaxed">
                Word documents (.docx, .doc) cannot be previewed natively in the
                browser. Download the file locally or upload a PDF version to
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="border-t border-zinc-900 pt-6 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div
                    className={`text-3xl font-extrabold flex items-center justify-center h-16 w-16 rounded-2xl border ${scoreColorClass} shadow-md`}
                  >
                    {score}%
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-0.5">
                      {score < 60 ? "Action recommended" : "Score calculated"}
                    </p>
                  </div>
                </div>
              ...
              <div className="border-t border-zinc-900 pt-6 flex flex-col gap-3">
                ...
                <AnalyzeResumeButton resumeId={resume._id.toString()} />
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Most recruiting organizations scan applications using AI
                  parsers. Click &quot;Run ATS Analysis&quot; to identify
                  formatting improvements, structural suggestions, and missing
                  key phrases to align with job descriptions.
                </p>
              </div>
            </div>
          </Card>
